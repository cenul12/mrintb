...
<html>
<head>
    <title>Cetak Data Rapat MRI NTB</title>
...
<body>
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
           <?php
                $no = 1;
                foreach ($data_rapat as $drapat) {
            ?>
            <tr>
                <td style="text-align: center"><?php echo $no++ ?></td>
                <td><?php echo $drapat->judul; ?></td>
                <td><?php echo date('d F Y', strtotime($drapat->tanggal)); ?></td>
                <td><img src='<?php echo site_url()?>assets/Img/<?php echo $drapat->foto; ?>' width="100%" height="40%"></td>
            </tr>
            <?php
             }
            ?>
