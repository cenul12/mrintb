<div class="banner_bottom">
		<div><br><br><br>
            ...
            <main>
			<h3 class="tittle-w3ls we banner_bottom_in">Syarat Dan Ketentuan </h3>
				   <p class="center"> 
					   	Syarat dan ketentuan menjadi relawan Masyarakat Relawan Indonesia (MRI) dibuat sebagai panduan
					    ...
					    <br><br>
					    Setiap orang yang bergabung menjadi relawan MRI memiliki hak dan kewajiban yang sama tanpa
				    ...
				    <p class="center">
					    ...
					    aktifitas bersama dengan kepengurusan MRI maupun komunitas.
					    <br><br>
					...
					<p class="center">
					    ...
					    diselenggarakan pengurus MRI. Jenjang relawan bukan untuk perlakuan istimewa namun lebih
					...
					<ol class="center">
					    ...
					    <li>Penggunaan segala jenis alkohol, narkotika dan zat adiktif yang dilarang hukum.</li>
					</ol>
					</p>
			</main>
		</div>
